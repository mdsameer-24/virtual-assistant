...
# workbook = openpyxl.load_workbook('C:\\Users\\DELL\\Downloads\\sam.xlsx')
...
class MainThread(QThread):
    ...
    def Task_Gui(self):
        ...
        while(True):
            ...
            print(instruction)
        # instruction=instruction.replace( "of ","")
            f=0
            ...
            if "director" in instruction:
                 f=f+1
                 print("Dr Jandhyala N Murthy, Professor and Director of GRIET studied PUC(MPC) from Maharajah’s College of Vizianagaram(1969-70) and then BTech(Mechanical) from IIT Madras (1970-75), MS (Thermal Power)(1982-84)and PhD (Thermal Power)(1985-88) from Cranfield Institute of Technology, UK.")
                 talk("Dr Jandhyala N Murthy, Professor and Director of GRIET studied PUC(MPC) from Maharajah’s College of Vizianagaram(1969-70) and then BTech(Mechanical) from IIT Madras (1970-75), MS (Thermal Power)(1982-84)and PhD (Thermal Power)(1985-88) from Cranfield Institute of Technology, UK.")

            elif "principal" in instruction:
                 f=f+1
                 print("Dr. J Praveen has done his PhD from Osmania University in power electronics, Hyderabad. His research work carried out at BHEL Research and Development Center with the support of University Grants Commission (UGC) Junior Research Fellowship (JRF).")
                 talk("Dr. J Praveen has done his PhD from Osmania University in power electronics, Hyderabad. His research work carried out at BHEL Research and Development Center with the support of University Grants Commission (UGC) Junior Research Fellowship (JRF).")
            
            elif "contact " in instruction:
...
class Gui_Start(QMainWindow):
    ...
    def startFunc(self):
            ...
            # self.zax_ui.jargif=QtGui.QMovie("material\Jarvis_Gui (1).gif")
    ...
    #             self.zax_ui.terminalOutputBox.appendPlainText(text)
